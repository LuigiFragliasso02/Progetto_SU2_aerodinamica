...
if __name__ == "__main__":
    ...
    plot_coefficiente(files_confronto_base, plot_configs_confronto_base, os.path.join(PLOT_DIR, "10_confronto_polare_n0012_i0_con_Ladson.png"),
                    x_col="cl", y_col="cd", title="Confronto Polare ($C_d$ vs $C_l$) (Simulazione vs Dati Sperimentali)", x_label="$C_l$", y_label="$C_d$", x_min=-1, x_max=1, highlight_last_point=0)
