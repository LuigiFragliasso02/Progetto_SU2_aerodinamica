...
if __name__ == "__main__":
    ...
    plot_coefficiente(files_confronto_base, plot_configs_confronto_base_1, os.path.join(PLOT_DIR, "5_4_confronto_polare_n0012_i0_con_Ladson_Y_plus=0.225.png"),
                x_col="cl", y_col="cd", title="Curva Polare ($C_d$ vs $C_l$) Simulazione vs Dati Sperimentali - NACA 0012, Re=6E06, M=0.15", x_label="$C_l$", y_label="$C_d$",y_min=-0.2, y_max=0.2, x_min=-0.20, x_max=0.20, highlight_last_point=0)
