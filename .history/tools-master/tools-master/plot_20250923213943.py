...
if __name__ == "__main__":
    ...
    plot_coefficiente(files_confronto_ladson, plot_configs_confronto_ladson, os.path.join(PLOT_DIR, "7_curva_polare_i0.002_0.005_con_confronto_ladson.png"),
                      x_col="cl", y_col="cd", title="Curva Polare - Simulazione vs Dati Sperimentali - NACA 0012, Re=6E06, M=0.15 - Dati Ladson", x_label="$C_l$", y_label="$C_d$", label_fontsize=16, title_fontsize=15, legend_fontsize=16)
    ...
    plot_coefficiente(files_polar_abott, plot_configs_polar_abott, os.path.join(PLOT_DIR, "9_curva_polare_confronto_i0.002_0.005_con_abott.png"),
                      x_col="cl", y_col="cd", title="Curva Polare - Simulazione vs Dati Sperimentali - NACA 0012, Re=6E06, M=0.15 - Dati Abott", x_label="$C_l$", y_label="$C_d$", label_fontsize=16, title_fontsize=13, legend_fontsize=16)
