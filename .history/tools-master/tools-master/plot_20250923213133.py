...
if __name__ == "__main__":
    ...
    plot_coefficiente(files_confronto_ladson, plot_configs_confronto_ladson, os.path.join(PLOT_DIR, "6_curva_portanza_confronto_i0.002_0.005_con_ladson.png"),
                      x_col="alfa", y_col="cl", title="Curva Portanza - Simulazione vs Dati Sperimentali (Free Transition)- NACA 0012, Re=6E06, M=0.15 - Dati Ladson", x_label="Alfa [°]", y_label="$C_l$", label_fontsize=16, title_fontsize=13, legend_fontsize=16)
    plot_coefficiente(files_confronto_ladson, plot_configs_confronto_ladson, os.path.join(PLOT_DIR, "7_curva_polare_i0.002_0.005_con_confronto_ladson.png"),
                      x_col="cl", y_col="cd", title="Confronto Polare ($C_d$ vs $C_l$) - Dati Ladson", x_label="$C_l$", y_label="$C_d$", label_fontsize=16, title_fontsize=15, legend_fontsize=16)
    ...
    plot_coefficiente(files_lift_abott, plot_configs_lift_abott, os.path.join(PLOT_DIR, "8_curva_portanza_confronto_i0.002_0.005_con_abott.png"),
                      x_col="alfa", y_col="cl", title="Curva Portanza - Simulazione vs Dati Sperimentali (Free Transition)- NACA 0012, Re=6E06, M=0.15 - Dati Abott", x_label="Alfa [°]", y_label="$C_l$")
