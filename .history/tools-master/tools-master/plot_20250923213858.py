...
if __name__ == "__main__":
    ...
    plot_coefficiente(files_confronto_ladson, plot_configs_confronto_ladson, os.path.join(PLOT_DIR, "7_curva_polare_i0.002_0.005_con_confronto_ladson.png"),
                      x_col="cl", y_col="cd", title="Curva Portanza - Simulazione vs Dati Sperimentali - NACA 0012, Re=6E06, M=0.15 - Dati Ladson", x_label="$C_l$", y_label="$C_d$", label_fontsize=16, title_fontsize=15, legend_fontsize=16)
