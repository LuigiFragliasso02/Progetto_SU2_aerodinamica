...
if __name__ == "__main__":
    ...
    plot_coefficiente(files_confronto_base, plot_configs_confronto_base_1, os.path.join(PLOT_DIR, "5_5_confronto_polare_n0012_i0_con_Ladson.png"),
    ...
    plot_coefficiente(files_confronto_base_2, plot_configs_confronto_base, os.path.join(PLOT_DIR, "4_1_confronto_portanza_n0012_i0_con_Ladson.png"),
                    x_col="alfa", y_col="cl", title="Confronto Portanza (Simulazione vs Dati Sperimentali)", x_label="Alfa [°]", y_label="$C_l$", highlight_last_point=0)
