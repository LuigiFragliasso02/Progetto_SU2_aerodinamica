...
if __name__ == "__main__":
    ...
    plot_coefficiente(files_confronto_base_2, plot_configs_confronto_base, os.path.join(PLOT_DIR, "4_2_confronto_portanza_n0012_i0_con_Ladson.png"),
                    x_col="alfa", y_col="cl", title="Confronto Portanza (Simulazione vs Dati Sperimentali)", x_label="Alfa [°]", y_label="$C_l$", label_fontsize=16, title_fontsize=15, legend_fontsize=16)
