...
if __name__ == "__main__":
    ...
    plot_coefficiente(files_mesh, plot_configs_mesh, os.path.join(PLOT_DIR, "2_curva_portanza_Variare_mesh_n0012_i0.png"),
                      x_col="alfa", y_col="cl", title="Curva di portanza al variare del mesh - NACA 0012, Re=6E06, M=0.15", x_label="Alfa [°]", y_label="$C_l$", label_fontsize=15, title_fontsize=17, legend_fontsize=15)
