...
if __name__ == "__main__":
    ...
    plot_configs_portanza_combinati = [
        ("Mesh 129x64", stile_numerico),
        ("Mesh 257x129", stile_numerico),
        ("Mesh 513x257", stile_numerico),
        ("Dati Sperimentali (Ladson)", stile_sperimentale)
    ...
    plot_coefficiente(
        ...
        x_col="alfa", 
        y_col="cl",
        title="Confronto Portanza: Variazione Mesh vs Dati Sperimentali",
        x_label="Alfa [°]", 
        y_label="$C_l$",
        label_fontsize=16, 
        title_fontsize=15, 
    ...
    plot_coefficiente(
        files_polare_combinati,
        plot_configs_polare_combinati,
        os.path.join(PLOT_DIR, "COMBINATO_polare_mesh_vs_sperimentale.png"),
        x_col="cl",  # <-- Asse X modificato
        y_col="cd", # <-- Asse Y modificato
        title="Confronto Curva Polare: Variazione Mesh vs Dati Sperimentali",
        x_label="$C_l$", # <-- Etichetta X modificata
        y_label="$C_d$", # <-- Etichetta Y modificata
        label_fontsize=16, 
        title_fontsize=15, 
        legend_fontsize=16
    )
