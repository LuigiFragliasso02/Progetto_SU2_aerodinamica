...
if __name__ == "__main__":
    ...
    plot_coefficiente(files_confronto_ladson, plot_configs_confronto_ladson, os.path.join(PLOT_DIR, "6_curva_portanza_confronto_i0.002_0.005_con_ladson.png"),
                      x_col="alfa", y_col="cl", title="Curva Portanza - Simulazione vs Dati Sperimentali (Free Transition)- NACA 0012, Re=6E06, M=0.15", x_label="Alfa [°]", y_label="$C_l$", label_fontsize=16, title_fontsize=15, legend_fontsize=16)
